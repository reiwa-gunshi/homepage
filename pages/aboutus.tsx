        ...
        <div className={styles.container}>
          ...
          >
            ...
            >
              ...
              <motion.p variants={childFadeItems} className={styles.detail}>
                令和の軍師は、顧客を先駆者に変える。先駆者は、固定観念や常識を打ち破る。新たな挑戦をして、独自の価値を生む。先駆者は、劇的な事業成長を手にする。業界に刺激を与え、業界を発展させる。パラダイムシフトの概念を生んだ学者、トーマス・クーン氏は提唱した。『その引金を引くのは若者・よそ者だ』と。日本一若いブランディング会社としてＺ世代のアイデアと発想力を駆使して、業界に変革を生みだす。さぁ、時代を進めよう。
              </motion.p>
            </section>
            <section>
          ...
          >
            ...
            >
              ...
              <motion.p variants={childFadeItems} className={styles.detail}>
                戦いに勝利し、歴史に名を残した英雄たち、その成功の陰に、必ず軍師あり。世はＩＴ戦国時代だ。企業の戦を勝利に導く、令和時代の軍師となる。そんな熱い想いから、「令和の軍師」と名付けた。コンセプトを体現する和のビジュアルに仕上げた。古風ではなく、令和に相応しい和のデザインだ。ロゴは社名であるドアを家紋に組み込む。服装は着物、本社は築百年の古民家、ここまで徹底する。
              </motion.p>
            </section>
            <section>
              <div className={styles.mission_img}>
