  ...
  const threePoint = [
    {
      ttl: "商品＆サービス開発",
      contents:
        "・新規事業開発や、既存事業の改善にも対応します。競合に確実に勝てる商品＆サービスを開発すべく、ターゲット選定・マーケティング調査から実施します。\nアイデア開発だけでなく、実施まで伴走します。",
    },
    {
      ttl: "ブランディング戦略（見せ方）",
      contents:
          ...
          <div className={styles.service_detail}>
            <div ref={worksRef} className={styles.serviceFirstZoon}>
              ...
              <div className={styles.service_content_p}>
                <p>
                  マーケティングの全てを提案・相談できる、マーケティング責任者＝軍師を提供します。
                  <br />
                  毎月定額で打ち合わせ＆相談回数は無制限。
                  <br />
                  デザイン・映像・広告の制作は別途見積り。
                  <br />
                  一方、制作を成功させるディレクションや、レクチャーであれば軍師プランで実施可能。
                </p>
              </div>
