...
import { volunteer_type } from "../lib/type";

const VolunteerPost: volunteer_type[] = [
  {
    ttl: "古民家オフィス",
...
const Volunteer: NextPage = () => {
  //恒例のタイトルとディスクリプション変換
  const description = "株式会社令和の軍師が行っているボランティアです。";
  const title = "Volunteer -ボランティア-";
            ...
            <div className={styles.container}>
              ...
              >
                <ul className={styles.bestWork_ul} ref={container}>
                  {VolunteerPost.map(
                    (items: any, Volunteer_index: number) => {
                      return (
                        <>
                          <motion.li
                            key={Volunteer_index}
